import{B as Y,s as G,c as h,o as l,a as S,m as u,A as wt,b as M,r as b,d as Z,f as ae,e as It,g as Ge,z as We,h as Ie,R as de,T as ce,i as z,j as D,F as R,k as ee,l as j,n as Ct,p as St,q as se,t as Pt,M as De,u as Ot,v as kt,w as X,Y as Lt,I as $t,x as xt,D as Ft,y as Pe,S as Tt,L as zt,C as Dt,$ as Bt,E as Vt,G as q,H as le,J as oe,K as B,N as L,O as H,P as E,Q as V,U as Mt,V as Je,W as fe,X as te,Z as At,_ as Rt,a0 as Be,a1 as Et,a2 as we,a3 as Nt,a4 as Kt,a5 as jt,a6 as Ht,a7 as J,a8 as Ut,a9 as Ve,aa as Gt,ab as Wt,ac as re,ad as Me}from"./index-38waE_xF.js";var Jt=`
    .p-paginator {
        display: flex;
        align-items: center;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function qi(t,e){if(t){if(typeof t=="string")return xe(t,e);var n={}.toString.call(t).slice(8,-1);return n==="Object"&&t.constructor&&(n=t.constructor.name),n==="Map"||n==="Set"?Array.from(t):n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?xe(t,e):void 0}}function Zi(t){if(typeof Symbol<"u"&&t[Symbol.iterator]!=null||t["@@iterator"]!=null)return Array.from(t)}function Xi(t){if(Array.isArray(t))return xe(t)}function xe(t,e){(e==null||e>t.length)&&(e=t.length);for(var n=0,r=Array(e);n<e;n++)r[n]=t[n];return r}var yt={name:"DataView",extends:Gi,inheritAttrs:!1,emits:["update:first","update:rows","page"],data:function(){return{d_first:this.first,d_rows:this.rows}},watch:{first:function(e){this.d_first=e},rows:function(e){this.d_rows=e},sortField:function(){this.resetPage()},sortOrder:function(){this.resetPage()}},methods:{getKey:function(e,n){return this.dataKey?q(e,this.dataKey):n},onPage:function(e){this.d_first=e.first,this.d_rows=e.rows,this.$emit("update:first",this.d_first),this.$emit("update:rows",this.d_rows),this.$emit("page",e)},sort:function(){var e=this;if(this.value){var n=Wi(this.value),r=Kt();return n.sort(function(a,i){var o=q(a,e.sortField),s=q(i,e.sortField);return jt(o,s,e.sortOrder,r)}),n}else return null},resetPage:function(){this.d_first=0,this.$emit("update:first",this.d_first)}},computed:{getTotalRecords:function(){return this.totalRecords?this.totalRecords:this.value?this.value.length:0},empty:function(){return!this.value||this.value.length===0},emptyMessageText:function(){var e;return((e=this.$primevue.config)===null||e===void 0||(e=e.locale)===null||e===void 0?void 0:e.emptyMessage)||""},paginatorTop:function(){return this.paginator&&(this.paginatorPosition!=="bottom"||this.paginatorPosition==="both")},paginatorBottom:function(){return this.paginator&&(this.paginatorPosition!=="top"||this.paginatorPosition==="both")},items:function(){if(this.value&&this.value.length){var e=this.value;if(e&&e.length&&this.sortField&&(e=this.sort()),this.paginator){var n=this.lazy?0:this.d_first;return e.slice(n,n+this.d_rows)}else return e}else return null}},components:{DVPaginator:vt}};function Yi(t,e,n,r,a,i){var o=z("DVPaginator");return l(),h("div",u({class:t.cx("root")},t.ptmi("root")),[t.$slots.header?(l(),h("div",u({key:0,class:t.cx("header")},t.ptm("header")),[b(t.$slots,"header")],16)):D("",!0),i.paginatorTop?(l(),L(o,{key:1,rows:a.d_rows,first:a.d_first,totalRecords:i.getTotalRecords,pageLinkSize:t.pageLinkSize,template:t.paginatorTemplate,rowsPerPageOptions:t.rowsPerPageOptions,currentPageReportTemplate:t.currentPageReportTemplate,class:E(t.cx("pcPaginator",{position:"top"})),alwaysShow:t.alwaysShowPaginator,onPage:e[0]||(e[0]=function(s){return i.onPage(s)}),unstyled:t.unstyled,pt:t.ptm("pcPaginator")},fe({_:2},[t.$slots.paginatorcontainer?{name:"container",fn:V(function(s){return[b(t.$slots,"paginatorcontainer",{first:s.first,last:s.last,rows:s.rows,page:s.page,pageCount:s.pageCount,pageLinks:s.pageLinks,totalRecords:s.totalRecords,firstPageCallback:s.firstPageCallback,lastPageCallback:s.lastPageCallback,prevPageCallback:s.prevPageCallback,nextPageCallback:s.nextPageCallback,rowChangeCallback:s.rowChangeCallback,changePageCallback:s.changePageCallback})]}),key:"0"}:void 0,t.$slots.paginatorstart?{name:"start",fn:V(function(){return[b(t.$slots,"paginatorstart")]}),key:"1"}:void 0,t.$slots.paginatorend?{name:"end",fn:V(function(){return[b(t.$slots,"paginatorend")]}),key:"2"}:void 0]),1032,["rows","first","totalRecords","pageLinkSize","template","rowsPerPageOptions","currentPageReportTemplate","class","alwaysShow","unstyled","pt"])):D("",!0),S("div",u({class:t.cx("content")},t.ptm("content")),[i.empty?(l(),h("div",u({key:1,class:t.cx("emptyMessage")},t.ptm("emptyMessage")),[b(t.$slots,"empty",{layout:t.layout},function(){return[oe(B(i.emptyMessageText),1)]})],16)):(l(),h(R,{key:0},[t.$slots.list&&t.layout==="list"?b(t.$slots,"list",{key:0,items:i.items}):D("",!0),t.$slots.grid&&t.layout==="grid"?b(t.$slots,"grid",{key:1,items:i.items}):D("",!0)],64))],16),i.paginatorBottom?(l(),L(o,{key:2,rows:a.d_rows,first:a.d_first,totalRecords:i.getTotalRecords,pageLinkSize:t.pageLinkSize,template:t.paginatorTemplate,rowsPerPageOptions:t.rowsPerPageOptions,currentPageReportTemplate:t.currentPageReportTemplate,class:E(t.cx("pcPaginator",{position:"bottom"})),alwaysShow:t.alwaysShowPaginator,onPage:e[1]||(e[1]=function(s){return i.onPage(s)}),unstyled:t.unstyled,pt:t.ptm("pcPaginator")},fe({_:2},[t.$slots.paginatorcontainer?{name:"container",fn:V(function(s){return[b(t.$slots,"paginatorcontainer",{first:s.first,last:s.last,rows:s.rows,page:s.page,pageCount:s.pageCount,pageLinks:s.pageLinks,totalRecords:s.totalRecords,firstPageCallback:s.firstPageCallback,lastPageCallback:s.lastPageCallback,prevPageCallback:s.prevPageCallback,nextPageCallback:s.nextPageCallback,rowChangeCallback:s.rowChangeCallback,changePageCallback:s.changePageCallback})]}),key:"0"}:void 0,t.$slots.paginatorstart?{name:"start",fn:V(function(){return[b(t.$slots,"paginatorstart")]}),key:"1"}:void 0,t.$slots.paginatorend?{name:"end",fn:V(function(){return[b(t.$slots,"paginatorend")]}),key:"2"}:void 0]),1032,["rows","first","totalRecords","pageLinkSize","template","rowsPerPageOptions","currentPageReportTemplate","class","alwaysShow","unstyled","pt"])):D("",!0),t.$slots.footer?(l(),h("div",u({key:3,class:t.cx("footer")},t.ptm("footer")),[b(t.$slots,"footer")],16)):D("",!0)],16)}yt.render=Yi;const Qi=Ht("followedItems",()=>{const t=J([]);function e(r){t.value.includes(r)||t.value.push(r)}function n(r){t.value=t.value.filter(a=>a!==r)}return{followedNames:t,follow:e,unfollow:n}},{persist:!0}),_i={class:"card"},er={class:"flex items-center gap-4 mb-4"},tr={class:"flex flex-col"},nr={class:"relative"},ir=["src"],rr={class:"flex flex-col md:flex-row justify-between md:items-center flex-1 gap-4"},ar={class:"flex flex-row md:flex-col justify-end items-start gap-2"},or={class:"text-md font-bold mt-2"},sr={class:"flex items-center justify-end gap-4"},lr={class:"text-xs text-gray-500 mt-1"},ur={class:"text-md font-semibold text-right flex justify-end",style:{"min-width":"100px"}},dr={style:{width:"20px","text-align":"center","margin-left":"10px"}},cr={key:0,class:"text-red-500"},pr={key:1,class:"text-green-500"},fr={key:2,class:"text-gray-500"},hr={class:"text-xs text-gray-500 text-right",style:{width:"100px"}},gr={__name:"Home",setup(t){const e=J([]),n=J(!1),r=J(""),a=J(""),i=Qi(),o=J({label:"Price: Low to High",value:"price"}),s=J(1),p=J("price"),d=J([{label:"Price: High to Low",value:"!price"},{label:"Price: Low to High",value:"price"},{label:"Show Followed",value:"followed"}]);function f(g){return i.followedNames.includes(g)}const c=Ve(()=>a.value?e.value.filter(g=>g.name&&g.name.toLowerCase().includes(a.value.toLowerCase())):e.value),v=Ve(()=>p.value==="followed"?[...c.value.filter(m=>f(m.name))].sort((m,y)=>{const x=Number(m.currPriceWei)||0,P=Number(y.currPriceWei)||0;return s.value===-1?P-x:x-P}):p.value?[...c.value].sort((C,m)=>{const y=Number(C.currPriceWei)||0,x=Number(m.currPriceWei)||0;return s.value===-1?x-y:y-x}):c.value);function I(g){const C=g.value.value,m=g.value;C.indexOf("!")===0?(s.value=-1,p.value=C.substring(1),o.value=m):(s.value=1,p.value=C,o.value=m)}function k(g){if(!g)return"";const C=new Date(g),m=String(C.getMonth()+1).padStart(2,"0"),y=String(C.getDate()).padStart(2,"0"),x=String(C.getHours()).padStart(2,"0"),P=String(C.getMinutes()).padStart(2,"0");return`${m}-${y} ${x}:${P}`}function $(g){return g?Number(g).toLocaleString():""}function w(g){if(!g)return;const C=encodeURIComponent(g).replace(/%20/g,"+");window.open(`https://msu.io/marketplace/nft?keyword=${C}`,"_blank")}async function O(){n.value=!0;try{const m=`https://aioblob.blob.core.windows.net/msn/all_item_with_price.csv?_=${Date.now()}`,y=await fetch(m);if(!y.ok)throw new Error(`下載失敗: ${m}`);const P=(await y.text()).trim().split(`
`),[F,...U]=P;e.value=U.map(N=>{const T=N.split(","),A=T[0],Q=T[1],ne=T[2],K=T[3],W=T[4],ie=BigInt(T[5])/10n**18n,Se=BigInt(T[6])/10n**18n,ue=T[7];return{name:A,price:Q,imageUrl:ne,timestamp:K,id:W,currPriceWei:ie,prevPriceWei:Se,updateTime:ue}}),console.log(e.value)}catch(g){r.value=g.message}finally{n.value=!1}}return Gt(()=>{O(),setInterval(O,6e5)}),(g,C)=>(l(),h("div",_i,[S("div",er,[te(S("input",{"onUpdate:modelValue":C[0]||(C[0]=m=>a.value=m),type:"text",placeholder:"Search Item Name...",class:"p-2 border rounded text-base flex-1"},null,512),[[Wt,a.value]]),j(re(Ce),{modelValue:o.value,"onUpdate:modelValue":C[1]||(C[1]=m=>o.value=m),options:d.value,optionLabel:"label",placeholder:"Sort by",onChange:C[2]||(C[2]=m=>I(m)),class:"w-48"},null,8,["modelValue","options"])]),j(re(yt),{value:v.value,paginator:"",rows:20},{list:V(m=>[S("div",tr,[(l(!0),h(R,null,ee(m.items,(y,x)=>(l(),h("div",{key:x},[S("div",{class:E(["flex flex-col sm:flex-row sm:items-center p-3 gap-4",{"border-t border-surface-200 dark:border-surface-700":x!==0}])},[S("div",nr,[S("img",{class:"block xl:block mx-auto rounded w-[30px] h-[30px]",src:y.imageUrl},null,8,ir)]),S("div",rr,[S("div",ar,[S("div",or,B(y.name),1)]),S("div",sr,[S("div",lr,B(k(y.updateTime)),1),S("span",ur,[oe(" $"+B($(y.currPriceWei))+" ",1),S("div",dr,[y.currPriceWei>y.prevPriceWei?(l(),h("span",cr,"↑")):y.currPriceWei<y.prevPriceWei?(l(),h("span",pr,"↓")):y.currPriceWei===y.prevPriceWei?(l(),h("span",fr,"=")):D("",!0)])]),S("div",hr," prev: $"+B($(y.prevPriceWei)),1),j(re(Me),{icon:"pi pi-heart",severity:f(y.name)?"danger":"primary",outlined:!f(y.name),style:{width:"35px",height:"35px"},onClick:P=>f(y.name)?re(i).unfollow(y.name):re(i).follow(y.name)},null,8,["severity","outlined","onClick"]),j(re(Me),{icon:"pi pi-link",style:{width:"35px",height:"35px"},onClick:P=>w(y.name)},null,8,["onClick"])])])],2)]))),128))])]),_:1},8,["value"])]))}},br=Ut(gr,[["__scopeId","data-v-0daf92c1"]]);export{br as default};
